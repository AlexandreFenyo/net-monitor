...
A view is a net-monitor JavaScript object that associates a chart to a subset of a data set. This subset contains only the data needed to display the data set
...
-->
<!--stackedit_data:
eyJoaXN0b3J5IjpbMTgxMDExMDk1Ml19
-->