...
A view is a net-monitor JavaScript object that associates a chart to a part of a data set. The data set part associated to
...
-->
<!--stackedit_data:
eyJoaXN0b3J5IjpbLTM1OTU1ODY2M119
-->