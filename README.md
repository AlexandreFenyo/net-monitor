...
A view is a net-monitor JavaScript object that associates a chart to a subset of a data set. This subset contains only the data with a timestamp inside the latest X seconds. X is the lifetime of the v
...
-->
<!--stackedit_data:
eyJoaXN0b3J5IjpbLTE2MTA0ODQ4MTldfQ==
-->