...
A live demo displaying the ingress and egress throughputs of my ADSL box at home is available here:
...
For instance, suppose that the html page using net-monitor has been loaded from http[s]://[hostname]:[port]/[local-part] (ex: https://myserver.com/myapp/app.html). When dispatchUrl is not used, the net-monitor JavaScript client computes the server URL using the protocol, hostname and port from the URL of the page, and adds the context `/net-monitor`. this way, : http[s]://[hostname]:[port]/net-monitor
...
-->
<!--stackedit_data:
eyJoaXN0b3J5IjpbMTc1Mjg4MTg0Nl19
-->