...
- the lifetime associated to a data set: this value defines the time before data are discarded from the data set (remember that a data set can contain one data older than the life time of the set).
...
-->
<!--stackedit_data:
eyJoaXN0b3J5IjpbLTI1Nzk4MTEyN119
-->