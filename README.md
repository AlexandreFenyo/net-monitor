...
You can install net-monitor from the [npmjs repository](https://www.npmjs.com/) using your favorite package manager: [npm](https://www.npmjs.com/docs/orgs/) or [yarn](https://yarnpkg.com/fr/) (avoid using bower for new client side modules). This will install net-monitor and its dependencies.
...
-->
<!--stackedit_data:
eyJoaXN0b3J5IjpbLTkwNzEzOTA0M119
-->