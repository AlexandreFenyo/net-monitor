...
- the lifetime associated to a data set: this value defines the time before data are discarded from the data set (remember that a set can contain one data older than the life time of the set).
...
-->
<!--stackedit_data:
eyJoaXN0b3J5IjpbMTIxNTIzMDk4N119
-->