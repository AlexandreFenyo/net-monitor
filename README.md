...
- when a probe pushes a new value to a data set that has already been created, its initial lifetime is the one specified by the probe for this value, or 0 if the probe omits to specify a lifetime.
...
-->
<!--stackedit_data:
eyJoaXN0b3J5IjpbMTg0MjgyMDA4OF19
-->