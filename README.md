...
Finally, publish the net-monitor project to the tomcat server: open the **Servers** view, select the server, right click and select **Add and Remove**
...
-->
<!--stackedit_data:
eyJoaXN0b3J5IjpbNTcyODYyMDE5XX0=
-->