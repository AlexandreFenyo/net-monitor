...
Finally, publish the net-monitor project into the tomcat server: open the **Servers** view, select the server, right click and select **Add and Remove**, then add the project.
...
-->
<!--stackedit_data:
eyJoaXN0b3J5IjpbMTY1MTY0NjQ3Nl19
-->