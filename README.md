...
- Regularly, the manager moves the data displayed on the chart to the left, for them to follow the x-axis time scale. If some data is no longer useful for drawing the chart, it is remove from the local copy of the dataset.
...
-->
<!--stackedit_data:
eyJoaXN0b3J5IjpbLTE2MTEzNjgxNTJdfQ==
-->