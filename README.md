...
The sources available from GitHub can be imported in Eclipse as a project with [Spring MVC](http://www.springframework.org/) and  [Maven](https://maven.apache.org/) nature.
...
-->
<!--stackedit_data:
eyJoaXN0b3J5IjpbMTc1OTYxMTM0Nl19
-->