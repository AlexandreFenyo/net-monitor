...
- when a probe pushes a new value to a data set with a name not already associated to an existing one, a new data set is created with this name. Its initial lifetime is the one specified by the probe for this value, or 0 if the probe omits to specify a lifetime.
...
-->
<!--stackedit_data:
eyJoaXN0b3J5IjpbMTYwNDYzMDY3NF19
-->