...
There is currently one global optionnal parameter: `dispatchUrl`. This parameter is used when the base URL (http[s]://[hostname]:[port]/[context]) of the web page that makes use of net-monitor is not the same that the base URL of the server side of net-monitor (http[s]://[installation-hostname]:[installation-port]/net-monitor). Typically, 
...
-->
<!--stackedit_data:
eyJoaXN0b3J5IjpbMjAyOTQyNDgzNV19
-->