...
Therefore, you can launch the net-monitor server with Eclipse on port 8080. The net-monitor server answers to requests to http://localhost:8080/net-monitor and 
...
-->
<!--stackedit_data:
eyJoaXN0b3J5IjpbODA5MDU5MzI2XX0=
-->