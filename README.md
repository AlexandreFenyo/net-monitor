...
The rate should be about ten times the update rate of the OID value, for the manager to collect the data just when it changes. This is important since net-snmp computes throughputs by dividing the difference between this new value and the previous one by the delay. Therefore, the delay must be 
...
-->
<!--stackedit_data:
eyJoaXN0b3J5IjpbLTIxMjc1MTkwNl19
-->