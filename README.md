...
Install a recent JDK (1.8.x or higher), install a version of Eclipse (Neon.3 or higher) including STS (String https://spring.io/tools/sts)
...
-->
<!--stackedit_data:
eyJoaXN0b3J5IjpbMTcxMTgxNDQ2M119
-->