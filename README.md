...
See the chapter _Build client library and server from the sources_ below to make a build, then get the JavaScript builds from the repository  src/main/javascript/public
...
-->
<!--stackedit_data:
eyJoaXN0b3J5IjpbMTQzMTExMzIzMF19
-->