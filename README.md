...
net-monitor aims to create charts for you, and dynamically update the data associated to those charts.

### manager

net-monitor lets you delegate the management of charts and data sets to a manager.
...
-->
<!--stackedit_data:
eyJoaXN0b3J5IjpbMTE0NDM1NzI5NV19
-->