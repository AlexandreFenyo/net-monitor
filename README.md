...
- a [STOMP](http://jmesnil.net/stomp-websocket/doc/) message broker over [RFC-6455](https://tools.ietf.org/html/rfc6455) [WebSocket](https://en.wikipedia.org/wiki/WebSocket)
- 
...
-->
<!--stackedit_data:
eyJoaXN0b3J5IjpbLTMzMjA4MzM0M119
-->