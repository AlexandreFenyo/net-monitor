...
The implementation is very efficient: clients (browsers) do not poll the server. Instead, each client subscribe to its desia message broker, on top of a WebSocket.
...
-->
<!--stackedit_data:
eyJoaXN0b3J5IjpbLTM5Mjg0MDY1OF19
-->