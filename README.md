...
Finally, publish the net-monitor project to the tomcat server: open the **Servers** view, select the server, right click and select **Add and Remove**, then add the project.
...
-->
<!--stackedit_data:
eyJoaXN0b3J5IjpbLTk0ODQ2OTE2N119
-->