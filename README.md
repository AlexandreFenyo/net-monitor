...
A view is a net-monitor JavaScript object that associates a chart to a part of a data set. The data set part associated to the view 
...
-->
<!--stackedit_data:
eyJoaXN0b3J5IjpbLTE1ODcxOTM1NV19
-->