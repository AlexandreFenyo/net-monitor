...
net-monitor lets you delegate the management of chart views and data sets to a manager. From the point of view of a manager, there is a one-to-one association between a chart view and a data set. If you want to display multiple charts associated to the same data set, just create multiple managers. This may be useful to display different views of the same data set, for instance a shjorview populated withthe last 60 seconds of the data, and a 
...
-->
<!--stackedit_data:
eyJoaXN0b3J5IjpbMTQwNTk3ODk2Ml19
-->