...
- When you add a data value by means of an external probe, push the data with a lifetime that is greater than the greatest time scale of the views that already or will display the corresponding dataset.
...
-->
<!--stackedit_data:
eyJoaXN0b3J5IjpbMTk2NTk4MjAxNV19
-->