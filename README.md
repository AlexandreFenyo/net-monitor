...
- If you apply changes to the JavaScript sources in `src\main\javascript\src`, you need to wait for webpack to apply changes to the `src\main\javascript\public` , then click on 
...
-->
<!--stackedit_data:
eyJoaXN0b3J5IjpbLTY1NzQ2NzY3NV19
-->