...
If you want to change the time scale displayed by a view, just ask the manager to unmanage the view and create a new manager to manage it again.
...
-->
<!--stackedit_data:
eyJoaXN0b3J5IjpbMTIwMDM5Njg3Ml19
-->