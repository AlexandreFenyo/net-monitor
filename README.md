...
You can install net-monitor from the [npmjs repository](https://www.npmjs.com/) using npm or yarn (avoid using bower for new client side modules). This will install net-monitor and its dependencies.
...
-->
<!--stackedit_data:
eyJoaXN0b3J5IjpbLTEwMzUzMzEzNzFdfQ==
-->