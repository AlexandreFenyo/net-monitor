...
A view is a net-monitor JavaScript object that associates a chart to a subset of a data set. This subset contains only the data with a timestamp inside the latest X seconds. X is the lifetime of the view.
...
-->
<!--stackedit_data:
eyJoaXN0b3J5IjpbMTA5MTM5NTM2MF19
-->