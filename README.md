...
Therefore, the data set lifetime can only be increased, decreasing it is forbidden. This rule is important to avoid views displaying a larger time scale than the available dataset range, after having changed the configuration of the lifetime of an external probe.
...
-->
<!--stackedit_data:
eyJoaXN0b3J5IjpbMTU5OTU3ODIxMF19
-->