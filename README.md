...
- internal probes :
  such a probe run in the net-monitor server and is associated to a data set. Each time it collects a data, this data is pushes into the data set. There is currently one type of internal probes: SNMP probes, that collect 
...
-->
<!--stackedit_data:
eyJoaXN0b3J5IjpbLTE4Njg1MDcxMl19
-->