...
**To sum up, a data set has a name, a life time and contains a set of timestamped data, maintained in the net-monitor server memory. It is created by a probe adding a new value to a named dataset not already instanciated. **
...
-->
<!--stackedit_data:
eyJoaXN0b3J5IjpbMzgzMjIxMTY2XX0=
-->