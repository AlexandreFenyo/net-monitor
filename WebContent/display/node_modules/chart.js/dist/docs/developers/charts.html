				...
				<ul class="summary">
					...
					<li class="chapter " data-level="1.7" data-path="./"><a
						...
						<ul class="articles">
							...
							<li class="chapter active" data-level="1.7.4"
								data-path="charts.html"><a href="charts.html"> New
									Charts </a></li>
						...
						<div class="search-plus" id="book-search-results">
							<div class="search-noresults">
								...
								<section class="normal markdown-section">
									...
									<p>Chart.js 2.0 introduces the concept of controllers for
										each dataset. Like scales, new controllers can be written as
										needed.</p>
									<pre>
										<code class="lang-javascript">Chart.controllers.MyType = Chart.DatasetController.extend({
...
<span class="hljs-keyword">new</span> Chart(ctx, {
    ...
    options: options
									...
									<h2 id="dataset-controller-interface">Dataset Controller
										Interface</h2>
									<p>Dataset controllers must implement the following
										interface.</p>
									<pre>
    ...
    addElements: <span class="hljs-function"><span
    ...
    addElementAndReset: <span class="hljs-function"><span
												class="hljs-keyword">function</span>(<span
    ...
    draw: <span class="hljs-function"><span class="hljs-keyword">function</span>(<span
												class="hljs-params">ease</span>) </span>{},

    <span class="hljs-comment">// Remove hover styling from the given element</span>
    removeHoverStyle: <span class="hljs-function"><span
												class="hljs-keyword">function</span>(<span
												class="hljs-params">element</span>) </span>{},

    <span class="hljs-comment">// Add hover styling to the given element</span>
    setHoverStyle: <span class="hljs-function"><span
												class="hljs-keyword">function</span>(<span
												class="hljs-params">element</span>) </span>{},
    ...
    update: <span class="hljs-function"><span
												class="hljs-keyword">function</span>(<span
												class="hljs-params">reset</span>) </span>{},
}
</code>
									</pre>
									<p>The following methods may optionally be overridden by
										derived dataset controllers</p>
									<pre>
										<code class="lang-javascript">{
    <span class="hljs-comment">// Initializes the controller</span>
    initialize: <span class="hljs-function"><span
												class="hljs-keyword">function</span>(<span
												class="hljs-params">chart, datasetIndex</span>) </span>{},
    ...
    linkScales: <span class="hljs-function"><span
												class="hljs-keyword">function</span>(<span
												class="hljs-params"></span>) </span>{},
    ...
    buildOrUpdateElements: <span class="hljs-function"><span
												class="hljs-keyword">function</span>(<span
												class="hljs-params"></span>) </span>{}
}
</code>
									</pre>
									<h2 id="extending-existing-chart-types">Extending Existing
										Chart Types</h2>
									<p>Extending or replacing an existing controller type is
										easy. Simply replace the constructor for one of the built in
										types with your own.</p>
									...
									<p>For example, to derive a new chart type that extends
										from a bubble chart, you would do the following.</p>
									<pre>
										<code class="lang-javascript">
											<span class="hljs-comment">// Sets the default config for &apos;derivedBubble&apos; to be the same as the bubble defaults. </span>
...
<span class="hljs-keyword">var</span> custom = Chart.controllers.bubble.extend({
    draw: <span class="hljs-function"><span class="hljs-keyword">function</span>(<span
        ...
        Chart.controllers.bubble.prototype.draw.call(<span
												class="hljs-keyword">this</span>, ease);
        ...
        <span class="hljs-keyword">var</span> meta = <span
												class="hljs-keyword">this</span>.getMeta();
        <span class="hljs-keyword">var</span> pt0 = meta.data[<span
												class="hljs-number">0</span>];
        <span class="hljs-keyword">var</span> radius = pt0._view.radius;

        <span class="hljs-keyword">var</span> ctx = <span
												class="hljs-keyword">this</span>.chart.chart.ctx;
        ctx.save();
        ctx.strokeStyle = <span class="hljs-string">&apos;red&apos;</span>;
        ctx.lineWidth = <span class="hljs-number">1</span>;
        ctx.strokeRect(pt0._view.x - radius, pt0._view.y - radius, <span
												class="hljs-number">2</span> * radius, <span
												class="hljs-number">2</span> * radius);
        ctx.restore();
    }
});
...
<span class="hljs-keyword">new</span> Chart(ctx, {
    ...
    options: options,
									...
									<p>
										The bar controller has a special property that you should be
										aware of. To correctly calculate the width of a bar, the
										controller must determine the number of datasets that map to
										bars. To do this, the bar controller attaches a property
										<code>bar</code>
										to the dataset during initialization. If you are creating a
										replacement or updated bar controller, you should do the same.
										This will ensure that charts with regular bars and your new
										derived bars will work seamlessly.
									</p>
			...
			<a href="plugins.html" class="navigation navigation-prev "
				aria-label="Previous page: Plugins"> <i class="fa fa-angle-left"></i>
			</a> <a href="axes.html" class="navigation navigation-next "
				aria-label="Next page: New Axes"> <i class="fa fa-angle-right"></i>
			</a>
