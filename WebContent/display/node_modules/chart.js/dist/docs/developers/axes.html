				...
				<ul class="summary">
					...
					<li class="chapter " data-level="1.7" data-path="./"><a
						...
						<ul class="articles">
							...
							<li class="chapter active" data-level="1.7.5"
								data-path="axes.html"><a href="axes.html"> New Axes </a></li>
		...
		<div class="book-body">
			...
			<div class="body-inner">
				...
				<div class="book-header" role="navigation">
					...
					<!-- Title -->
					<h1>
						<i class="fa fa-circle-o-notch fa-spin"></i> <a href="..">New
							Axes</a>
					</h1>
				</div>
						...
						<div class="search-plus" id="book-search-results">
							<div class="search-noresults">
								...
								<section class="normal markdown-section">
									...
									<p>Axes in Chart.js can be individually extended. Axes
										should always derive from Chart.Scale but this is not a
										mandatory requirement.</p>
									<pre>
										<code class="lang-javascript">
											<span class="hljs-keyword">let</span> MyScale = Chart.Scale.extend({
...
<span class="hljs-comment">// MyScale is now derived from Chart.Scale</span>
									...
									<p>Once you have created your scale class, you need to
										register it with the global chart object so that it can be
										used. A default config for the scale may be provided when
										registering the constructor. The first parameter to the
										register function is a string key that is used later to
										identify which scale type to use for a chart.</p>
									<pre>
										<code class="lang-javascript">Chart.scaleService.registerScaleType(<span
												class="hljs-string">&apos;myScale&apos;</span>, MyScale, defaultConfigObject);
</code>
									</pre>
									<p>To use the new scale, simply pass in the string key to
										the config when creating a chart.</p>
									<pre>
										<code class="lang-javascript">
											<span class="hljs-keyword">var</span> lineChart = <span
    ...
    options: {
        scales: {
            yAxes: [{
                type: <span class="hljs-string">&apos;myScale&apos;</span> <span
												class="hljs-comment">// this is the same key that was passed to the registerScaleType function</span>
            }]
        }
    }
})
									...
									<p>Scale instances are given the following properties
										during the fitting process.</p>
									<pre>
										<code class="lang-javascript">{
    left: <span class="hljs-built_in">Number</span>, <span
												class="hljs-comment">// left edge of the scale bounding box</span>
    right: <span class="hljs-built_in">Number</span>, <span
												class="hljs-comment">// right edge of the bounding box&apos;</span>
    top: <span class="hljs-built_in">Number</span>,
    bottom: <span class="hljs-built_in">Number</span>,
    width: <span class="hljs-built_in">Number</span>, <span
												class="hljs-comment">// the same as right - left</span>
    height: <span class="hljs-built_in">Number</span>, <span
												class="hljs-comment">// the same as bottom - top</span>
    ...
    buildTicks: <span class="hljs-function"><span
												class="hljs-keyword">function</span>(<span
												class="hljs-params"></span>) </span>{},
    ...
    getLabelForIndex: <span class="hljs-function"><span
												class="hljs-keyword">function</span>(<span
												class="hljs-params">index, datasetIndex</span>) </span>{},
    ...
    getPixelForTick: <span class="hljs-function"><span
												class="hljs-keyword">function</span>(<span
												class="hljs-params">index, includeOffset</span>) </span>{},
    ...
    <span class="hljs-comment">// @param includeOffset : if true, get the pixel halway between the given tick and the next</span>
    getPixelForValue: <span class="hljs-function"><span
												class="hljs-keyword">function</span>(<span
												class="hljs-params">value, index, datasetIndex, includeOffset</span>) </span>{}
    ...
    getValueForPixel: <span class="hljs-function"><span
												class="hljs-keyword">function</span>(<span
												class="hljs-params">pixel</span>) </span>{}
}
</code>
									</pre>
									<p>
										Optionally, the following methods may also be overwritten, but
										an implementation is already provided by the
										<code>Chart.Scale</code>
										base class.
									</p>
									<pre>
										<code class="lang-javascript">    <span
												class="hljs-comment">// Transform the ticks array of the scale instance into strings. The default implementation simply calls this.options.ticks.callback(numericalTick, index, ticks);</span>
    convertTicksToLabels: <span class="hljs-function"><span
												class="hljs-keyword">function</span>(<span
												class="hljs-params"></span>) </span>{},
    ...
    calculateTickRotation: <span class="hljs-function"><span
												class="hljs-keyword">function</span>(<span
												class="hljs-params"></span>) </span>{},
    ...
    fit: <span class="hljs-function"><span class="hljs-keyword">function</span>(<span
												class="hljs-params"></span>) </span>{},
    ...
    draw: <span class="hljs-function"><span class="hljs-keyword">function</span>(<span
												class="hljs-params">chartArea</span>) </span>{},
</code>
									</pre>
									<p>The Core.Scale base class also has some utility
										functions that you may find useful.</p>
									<pre>
										<code class="lang-javascript">{
    <span class="hljs-comment">// Returns true if the scale instance is horizontal</span>
    isHorizontal: <span class="hljs-function"><span
												class="hljs-keyword">function</span>(<span
												class="hljs-params"></span>) </span>{},
    ...
    getRightValue: <span class="hljs-function"><span
												class="hljs-keyword">function</span>(<span
												class="hljs-params">dataValue</span>) </span>{},
}
</code>
									</pre>
			...
			<a href="charts.html" class="navigation navigation-prev "
				aria-label="Previous page: New Charts"> <i
				class="fa fa-angle-left"></i>
			</a> <a href="contributing.html" class="navigation navigation-next "
				aria-label="Next page: Contributing"> <i
