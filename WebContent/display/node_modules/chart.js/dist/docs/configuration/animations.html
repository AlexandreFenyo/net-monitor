...
<body>
				...
				<ul class="summary">
					...
					<li class="chapter " data-level="1.4" data-path="./"><a
						...
						<ul class="articles">
							...
							<li class="chapter active" data-level="1.4.1"
		...
		<div class="book-body">
			...
			<div class="body-inner">
				...
				<div class="book-header" role="navigation">
					...
					<!-- Title -->
					<h1>
						<i class="fa fa-circle-o-notch fa-spin"></i> <a href="..">Animations</a>
					</h1>
				</div>
						...
						<div class="search-plus" id="book-search-results">
							<div class="search-noresults">
								...
								<section class="normal markdown-section">
									...
									<p>Chart.js animates charts out of the box. A number of
										options are provided to configure how the animation looks and
										how long it takes</p>
									<h2 id="animation-configuration">Animation Configuration</h2>
									<p>
										The following animation options are available. The global
										options for are defined in
										<code>Chart.defaults.global.animation</code>
										.
									</p>
									<table>
										<thead>
									...
									<p>
										See <a href="http://robertpenner.com/easing/" target="_blank">Robert
											Penner&apos;s easing equations</a>.
									</p>
									...
									<p>
										...
										callbacks are useful for synchronizing an external draw to the
										chart animation. The callback is passed a
										<code>Chart.Animation</code>
										instance:
									</p>
									<pre>
    ...
    onAnimationComplete: <span class="hljs-built_in">Function</span>
									...
									<p>The following example fills a progress bar during the
										chart animation.</p>
									<pre>
										<code class="lang-javascript">
    ...
    options: {
        animation: {
            onProgress: <span class="hljs-function"><span
                ...
                progress.value = animation.animationObject.currentStep / animation.animationObject.numSteps;
									...
									<p>
										Another example usage of these callbacks can be found on <a
											href="https://github.com/chartjs/Chart.js/blob/master/samples/advanced/progress-bar.html"
											target="_blank">Github</a>: this sample displays a progress
										bar showing how far along the animation is.
									</p>
			...
			<a href="./" class="navigation navigation-prev "
				aria-label="Previous page: Configuration"> <i
				class="fa fa-angle-left"></i>
			</a> <a href="layout.html" class="navigation navigation-next "
				aria-label="Next page: Layout"> <i class="fa fa-angle-right"></i>
			</a>
