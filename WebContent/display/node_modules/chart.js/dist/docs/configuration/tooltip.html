		...
		<div class="book-summary">
			...
			<nav role="navigation">
				...
				<ul class="summary">
					...
					<li class="chapter " data-level="1.4" data-path="./"><a
						...
						<ul class="articles">
							...
							<li class="chapter " data-level="1.4.1"
								data-path="animations.html"><a href="animations.html">
							...
							<li class="chapter active" data-level="1.4.5"
								data-path="tooltip.html"><a href="tooltip.html">
					...
					<li class="chapter " data-level="1.5" data-path="../charts/">
						...
						<ul class="articles">
							...
							<li class="chapter " data-level="1.5.1"
								data-path="../charts/line.html"><a
								href="../charts/line.html"> Line </a></li>

							<li class="chapter " data-level="1.5.2"
								data-path="../charts/bar.html"><a href="../charts/bar.html">


									Bar </a></li>

							<li class="chapter " data-level="1.5.3"
								data-path="../charts/radar.html"><a
								href="../charts/radar.html"> Radar </a></li>

							<li class="chapter " data-level="1.5.4"
								data-path="../charts/doughnut.html"><a
								href="../charts/doughnut.html"> Doughnut & Pie </a></li>

							<li class="chapter " data-level="1.5.5"
								data-path="../charts/polar.html"><a
								href="../charts/polar.html"> Polar Area </a></li>

							<li class="chapter " data-level="1.5.6"
								data-path="../charts/bubble.html"><a
								href="../charts/bubble.html"> Bubble </a></li>

							<li class="chapter " data-level="1.5.7"
								data-path="../charts/scatter.html"><a
								href="../charts/scatter.html"> Scatter </a></li>

							<li class="chapter " data-level="1.5.8"
								data-path="../charts/area.html"><a
								href="../charts/area.html"> Area </a></li>

							<li class="chapter " data-level="1.5.9"
								data-path="../charts/mixed.html"><a
								href="../charts/mixed.html"> Mixed </a></li>
		...
		<div class="book-body">
			...
			<div class="body-inner">
				...
				<div class="book-header" role="navigation">
					...
					<!-- Title -->
					<h1>
						<i class="fa fa-circle-o-notch fa-spin"></i> <a href="..">Tooltip</a>
					</h1>
				</div>
						...
						<div class="search-plus" id="book-search-results">
							<div class="search-noresults">
								...
								<section class="normal markdown-section">
									...
									<p>
										The tooltip configuration is passed into the
										<code>options.tooltips</code>
										namespace. The global options for the chart tooltips is
										defined in
										<code>Chart.defaults.global.tooltips</code>
										.
									</p>
									<table>
										<thead>
										...
										<tbody>
											...
											<tr>
												...
												<td>See <a href="#external-custom-tooltips">custom
														tooltip</a> section.
												</td>
											</tr>
											<tr>
												...
												<td>Sets which elements appear in the tooltip. <a
													href="../general/interactions/modes.html#interaction-modes">more...</a>.
												</td>
											</tr>
											<tr>
												...
												<td><code>Boolean</code></td>
												<td><code>true</code></td>
												<td>if true, the tooltip mode applies only when the
													mouse position intersects with an element. If false, the
													mode will be applied at all times.</td>
											</tr>
											<tr>
												<td><code>position</code></td>
												<td><code>String</code></td>
												<td><code>&apos;average&apos;</code></td>
												<td>The mode for positioning the tooltip. <a
													href="#position-modes">more...</a></td>
											</tr>
											<tr>
											...
											<tr>
												...
												<td><code>&quot;&apos;Helvetica Neue&apos;,
														&apos;Helvetica&apos;, &apos;Arial&apos;, sans-serif&quot;</code></td>
												<td>title font</td>
											</tr>
											<tr>
											...
											<tr>
												...
												<td><code>Number</code></td>
												<td><code>2</code></td>
												<td>Spacing to add to top and bottom of each title
													line.</td>
											</tr>
											<tr>
											...
											<tr>
												...
												<td><code>Number</code></td>
												<td><code>2</code></td>
												<td>Spacing to add to top and bottom of each tooltip
													item.</td>
											</tr>
											<tr>
											...
											<tr>
												...
												<td><code>Number</code></td>
												<td><code>2</code></td>
												<td>Spacing to add to top and bottom of each fotter
													line.</td>
											</tr>
											<tr>
											...
											<tr>
												...
												<td><code>Number</code></td>
												<td><code>2</code></td>
												<td>Extra distance to move the end of the tooltip arrow
													away from the tooltip point.</td>
											</tr>
											<tr>
											...
											<tr>
												...
												<td><code>Color</code></td>
												<td><code>&apos;#fff&apos;</code></td>
												<td>Color to draw behind the colored boxes when
													multiple items are in the tooltip</td>
											</tr>
											<tr>
									...
									<p>&apos;average&apos; mode will place the tooltip at the
										...
										&apos;nearest&apos; will place the tooltip at the position of
										the element closest to the event position.</p>
 ...
 */</span>
Chart.Tooltip.positioners.custom = <span class="hljs-function"><span
												class="hljs-keyword">function</span>(<span
												class="hljs-params">elements, eventPosition</span>) </span>{
    <span class="hljs-comment">/** @type {Chart.Tooltip} */</span>
    <span class="hljs-keyword">var</span> tooltip = <span
    ...
    <span class="hljs-keyword">return</span> {
        ...
        y: <span class="hljs-number">0</span>
									...
									<p>
										Allows sorting of <a href="#tooltip-item-interface">tooltip
											items</a>. Must implement at minimum a function that can be
										passed to <a
											href="https://developer.mozilla.org/en-US/docs/Web/JavaScript/Reference/Global_Objects/Array/sort"
											target="_blank">Array.prototype.sort</a>. This function can
										also accept a third parameter that is the data object passed
										to the chart.
									</p>
									<h3 id="filter-callback">Filter Callback</h3>
									<p>
										Allows filtering of <a href="#tooltip-item-interface">tooltip
											items</a>. Must implement at minimum a function that can be
										passed to <a
											href="https://developer.mozilla.org/en/docs/Web/JavaScript/Reference/Global_Objects/Array/filter"
											target="_blank">Array.prototype.filter</a>. This function can
										also accept a second parameter that is the data object passed
										to the chart.
									</p>
									...
									<p>
										...
										<code>callbacks</code>
										key. The tooltip has the following callbacks for providing
										text. For all functions, &apos;this&apos; will be the tooltip
										object created from the Chart.Tooltip constructor.
									</p>
									<p>
										All functions are called with the same arguments: a <a
											href="#tooltip-item-interface">tooltip item</a> and the data
										object passed to the chart. All functions must return either a
										string or an array of strings. Arrays of strings are treated
									...
									<table>
										...
										<tbody>
											...
											<tr>
												...
												<td>Returns text to render before an individual label.
													This will be called for each item in the tooltip.</td>
											</tr>
											<tr>
												<td><code>label</code></td>
												<td><code>tooltipItem, data</code></td>
												<td>Returns text to render for an individual item in
													the tooltip.</td>
											</tr>
											<tr>
												<td><code>labelColor</code></td>
												<td><code>tooltipItem, chart</code></td>
												<td>Returns the colors to render for the tooltip item.
													<a href="#label-color-callback">more...</a>
												</td>
											</tr>
											<tr>
												<td><code>labelTextColor</code></td>
												<td><code>tooltipItem, chart</code></td>
												<td>Returns the colors for the text of the label for
													the tooltip item.</td>
											</tr>
											<tr>
											...
											<tr>
												...
												<td><code>Array[tooltipItem], data</code></td>
												<td>Returns text to render as the footer of the
													tooltip.</td>
											</tr>
											<tr>
									...
									<p>For example, to return a red box for each item in the
										tooltip you could do:</p>
									<pre>
										<code class="lang-javascript">
											<span class="hljs-keyword">var</span> chart = <span
    ...
    options: {
        tooltips: {
            callbacks: {
                labelColor: <span class="hljs-function"><span
												class="hljs-keyword">function</span>(<span
												class="hljs-params">tooltipItem, chart</span>) </span>{
                    <span class="hljs-keyword">return</span> {
                        borderColor: <span class="hljs-string">&apos;rgb(255, 0, 0)&apos;</span>,
                        backgroundColor: <span class="hljs-string">&apos;rgb(255, 0, 0)&apos;</span>
                    }
                },
                labelTextColor:<span class="hljs-function"><span
												class="hljs-keyword">function</span>(<span
												class="hljs-params">tooltipItem, chart</span>)</span>{
                    <span class="hljs-keyword">return</span> <span
												class="hljs-string">&apos;#543453&apos;</span>;
                }
            }
        }
    }
									...
									<p>The tooltip items passed to the tooltip callbacks
    ...
    y: <span class="hljs-built_in">Number</span>,
									...
									<h2 id="external-custom-tooltips">External (Custom)
										Tooltips</h2>
									<p>Custom tooltips allow you to hook into the tooltip
										rendering process so that you can render the tooltip in your
										own custom way. Generally this is used to create an HTML
										tooltip instead of an oncanvas one. You can enable custom
										tooltips in the global or chart configuration like so:</p>
									<pre>
										<code class="lang-javascript">
											<span class="hljs-keyword">var</span> myPieChart = <span
												class="hljs-keyword">new</span> Chart(ctx, {
    type: <span class="hljs-string">&apos;pie&apos;</span>,
    data: data,
    options: {
        tooltips: {
            custom: <span class="hljs-function"><span
												class="hljs-keyword">function</span>(<span
												class="hljs-params">tooltipModel</span>) </span>{
                <span class="hljs-comment">// Tooltip Element</span>
                <span class="hljs-keyword">var</span> tooltipEl = <span
												class="hljs-built_in">document</span>.getElementById(<span
												class="hljs-string">&apos;chartjs-tooltip&apos;</span>);

                <span class="hljs-comment">// Create element on first render</span>
                <span class="hljs-keyword">if</span> (!tooltipEl) {
                    tooltipEl = <span class="hljs-built_in">document</span>.createElement(<span
                ...
                <span class="hljs-keyword">if</span> (tooltipModel.opacity === <span
                ...
                tooltipEl.classList.remove(<span class="hljs-string">&apos;above&apos;</span>, <span
												class="hljs-string">&apos;below&apos;</span>, <span
												class="hljs-string">&apos;no-transform&apos;</span>);
                ...
                <span class="hljs-function"><span
												class="hljs-keyword">function</span> <span
												class="hljs-title">getBody</span>(<span class="hljs-params">bodyItem</span>) </span>{
                ...
                <span class="hljs-keyword">if</span> (tooltipModel.body) {
                    ...
                    <span class="hljs-keyword">var</span> innerHtml = <span
												class="hljs-string">&apos;&lt;thead&gt;&apos;</span>;

                    titleLines.forEach(<span class="hljs-function"><span
												class="hljs-keyword">function</span>(<span
												class="hljs-params">title</span>) </span>{
                        innerHtml += <span class="hljs-string">&apos;&lt;tr&gt;&lt;th&gt;&apos;</span> + title + <span
												class="hljs-string">&apos;&lt;/th&gt;&lt;/tr&gt;&apos;</span>;
                    });
                    innerHtml += <span class="hljs-string">&apos;&lt;/thead&gt;&lt;tbody&gt;&apos;</span>;

                    bodyLines.forEach(<span class="hljs-function"><span
												class="hljs-keyword">function</span>(<span
												class="hljs-params">body, i</span>) </span>{
                        <span class="hljs-keyword">var</span> colors = tooltipModel.labelColors[i];
                        <span class="hljs-keyword">var</span> style = <span
												class="hljs-string">&apos;background:&apos;</span> + colors.backgroundColor;
                        style += <span class="hljs-string">&apos;; border-color:&apos;</span> + colors.borderColor;
                        style += <span class="hljs-string">&apos;; border-width: 2px&apos;</span>;
                        <span class="hljs-keyword">var</span> span = <span
												class="hljs-string">&apos;&lt;span class=&quot;chartjs-tooltip-key&quot; style=&quot;&apos;</span> + style + <span
												class="hljs-string">&apos;&quot;&gt;&lt;/span&gt;&apos;</span>;
                        innerHtml += <span class="hljs-string">&apos;&lt;tr&gt;&lt;td&gt;&apos;</span> + span + body + <span
												class="hljs-string">&apos;&lt;/td&gt;&lt;/tr&gt;&apos;</span>;
                    });
                    innerHtml += <span class="hljs-string">&apos;&lt;/tbody&gt;&apos;</span>;

                    <span class="hljs-keyword">var</span> tableRoot = tooltipEl.querySelector(<span
												class="hljs-string">&apos;table&apos;</span>);
                    tableRoot.innerHTML = innerHtml;
                }

                <span class="hljs-comment">// `this` will be the overall tooltip</span>
                <span class="hljs-keyword">var</span> position = <span
												class="hljs-keyword">this</span>._chart.canvas.getBoundingClientRect();
                ...
                tooltipEl.style.left = position.left + tooltipModel.caretX + <span
												class="hljs-string">&apos;px&apos;</span>;
                tooltipEl.style.top = position.top + tooltipModel.caretY + <span
												class="hljs-string">&apos;px&apos;</span>;
                tooltipEl.style.fontFamily = tooltipModel._fontFamily;
                tooltipEl.style.fontSize = tooltipModel.fontSize;
                tooltipEl.style.fontStyle = tooltipModel._fontStyle;
                tooltipEl.style.padding = tooltipModel.yPadding + <span
												class="hljs-string">&apos;px &apos;</span> + tooltipModel.xPadding + <span
												class="hljs-string">&apos;px&apos;</span>;
            }
        }
    }
									...
									<p>
										See
										<code>samples/tooltips/line-customTooltips.html</code>
										for examples on how to get started.
									</p>
									<h2 id="tooltip-model">Tooltip Model</h2>
									<p>The tooltip model contains parameters that can be used
										to render the tooltip.</p>
									<pre>
										<code class="lang-javascript">{
    ...
    displayColors: <span class="hljs-built_in">Boolean</span>,
			...
			<a href="title.html" class="navigation navigation-prev "
				aria-label="Previous page: Title"> <i class="fa fa-angle-left"></i>
			</a> <a href="elements.html" class="navigation navigation-next "
				aria-label="Next page: Elements"> <i class="fa fa-angle-right"></i>
			</a>
