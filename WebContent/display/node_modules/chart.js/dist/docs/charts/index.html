	...
	<div class="book">
		<div class="book-summary">
			...
			<nav role="navigation">
				...
				<ul class="summary">
					...
					<li class="chapter active" data-level="1.5" data-path="./"><a
						href="./"> Charts </a>
		...
		<div class="book-body">
						...
						<div class="search-plus" id="book-search-results">
							<div class="search-noresults">
								...
								<section class="normal markdown-section">
									...
									<p>
										<a href="area.html">Area charts</a> can be built from a line
										or radar chart using the dataset
										<code>fill</code>
										option.
									</p>
									<p>
										To create a new chart type, see the <a
			...
			<a href="../configuration/elements.html"
				...
				aria-label="Previous page: Elements"> <i
				class="fa fa-angle-left"></i>
			</a> <a href="line.html" class="navigation navigation-next "
				aria-label="Next page: Line"> <i class="fa fa-angle-right"></i>
			</a>
